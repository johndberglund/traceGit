...
// draw vectors
  stroke("blue");
  var oldX = (baseX-xOffset)*sized+150-boxSize;
  var oldY = (baseY-yOffset)*sized-boxSize;
  rect(oldX,oldY,boxSize*2+1,boxSize*2+1);
  rect(oldX+Ax*sized,oldY+Ay*sized,boxSize*2+1,boxSize*2+1);
  rect(oldX+Bx*sized,oldY+By*sized,boxSize*2+1,boxSize*2+1);

  line(oldX+boxSize,oldY+boxSize,oldX+boxSize+Ax*sized,oldY+boxSize+Ay*sized);
  line(oldX+boxSize,oldY+boxSize,oldX+boxSize+Bx*sized,oldY+boxSize+By*sized);
